...
const layoutReportPositions = (reports) => {
  ...
  groups.forEach((group) => {
    ...
    group.forEach((report, index) => {
      ...
      laidOut.push({
        ...
        lng: report.longitude + lngOffsetBase * Math.cos(angle),
      });
    });
  });
...
const resetMarkerElevation = (marker) => {
  if (marker?.setZIndexOffset) {
    marker.setZIndexOffset(0);
  }
};

const CommunityReportsMap = ({ reports, selectedId, onViewReport }) => {
...
export default CommunityReportsMap;
